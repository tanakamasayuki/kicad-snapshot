...
TRANSLATIONS = {
    ...
    "zh": {
        ...
        "git_ok_plain": "git: 正常",
        "group_project": "2) 工程",
        "project_hint": "从最近工程中选择，或打开新工程",
        "open_project": "打开工程...",
        "remove_project": "从列表移除",
        "group_next": "3) 下一步",
        "next_hint": "仅当 CLI 版本已确认且已选择工程时可继续。",
        "continue": "继续到快照 / 对比",
        ...
        "compare_git_push": "推送",
        "compare_git_pull": "拉取",
        "compare_from": "与（之前）比较",
        "compare_to": "与（之后）比较",
        "compare_current_project": "[当前] 工程文件",
        "compare_run": "比较",
        "compare_git_unavailable": "此工程不可用 git。",
        "compare_need_two": "请选择两个比较目标。",
        "compare_same": "请选择不同工程。",
        ...
        "compare_visual_before": "之前",
        "compare_visual_after": "之后",
        "compare_visual_empty": "(空)",
        ...
        "compare_image_pcb_board": "PCB / 电路板",
        "compare_image_before": "之前图像",
        "compare_image_after": "之后图像",
        "compare_image_diff": "差分图像",
        "compare_image_auto": "自动切换",
        "compare_image_not_available": "仅对 .kicad_sch / .kicad_pcb 内容提供图像差异。",
        "compare_image_zoom_out": "缩小",
        "compare_image_zoom_in": "放大",
        "compare_image_zoom_fit": "适应",
        "compare_image_render_scale": "渲染倍率",
    ...
    "fr": {
        ...
        "git_refresh": "Detection auto Git",
        ...
        "compare_image_render_scale": "Echelle de rendu",
    ...
    "de": {
        ...
        "git_refresh": "Git automatisch erkennen",
        ...
        "compare_image_render_scale": "Render-Skalierung",
